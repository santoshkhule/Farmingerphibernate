...
<style>
	...
	#unitName { width:180px; padding:3px; }
		...
		<tbody>
			<%
				...
				for (UnitEntity unit : unitList) {
					String eName = unit.getUnitName() != null ? unit.getUnitName().replace("'", "\\'") : "";
			%>
			<tr id="row-<%=unit.getUnitId()%>">
				<td style="text-align:center;"><input type="checkbox" class="rowChk" value="<%=unit.getUnitId()%>" onchange="updateBulkBar()"></td>
